...
#define DLL_NAME L"Lyrics Tray Icon Fix Hook v0.108.dll"
...
static void usage(void) {
    print_rules();
    out(L"\nUsage:\n");
    out(L"  Lyrics Tray Icon Fix v0.108.exe start   start PS Tray Factory route\n");
    out(L"  Lyrics Tray Icon Fix v0.108.exe stop    stop background hooks\n");
    out(L"  Lyrics Tray Icon Fix v0.108.exe apply   sync current rules once\n");
    out(L"  Lyrics Tray Icon Fix v0.108.exe status  show status\n");
    out(L"  Lyrics Tray Icon Fix v0.108.exe recover  internal bounded Shell recovery\n");
}
