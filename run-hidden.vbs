...
exe = root & "\bin\Lyrics Tray Icon Fix v0.114.exe"
bin = root & "\bin"
...
oldFiles = Array( _
  ...
  "bin\Lyrics Tray Icon Fix Copy v0.111.exe", _
  "bin\Lyrics Tray Icon Fix Hook v0.112.dll", _
  "bin\Lyrics Tray Icon Fix PS Restore Hook v0.112.dll", _
  "bin\Lyrics Tray Icon Fix PS Restore Helper v0.112.exe", _
  "bin\Lyrics Tray Icon Fix v0.112.exe", _
  "bin\Lyrics Tray Icon Fix Copy v0.112.exe", _
  "bin\Lyrics Tray Icon Fix Hook v0.113.dll", _
  "bin\Lyrics Tray Icon Fix PS Restore Hook v0.113.dll", _
  "bin\Lyrics Tray Icon Fix PS Restore Helper v0.113.exe", _
  "bin\Lyrics Tray Icon Fix v0.113.exe", _
  "bin\Lyrics Tray Icon Fix Copy v0.113.exe")
